...
Vá em File > Import... > General > Projects from Folder or Archive.

Selecione a pasta onde o repositório foi clonado e clique em Finish.

Navegue até o arquivo Program.java do exercício que deseja testar e execute (Run as > Java Application).

✍️ Desenvolvido por João Lechinieski
>>>>>>> branch 'main' of https://github.com/Lechinieski/java-estudos-nelio-alves.git
